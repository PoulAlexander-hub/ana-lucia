...
function animar(timestamp) {
    ...
    if (crecimiento > 2.6) {
        ...
        if (!mensajeMostrado) {
            ...
            const texto = "Para Luci Luci, Quiero decirte que eres una persona increíble; nunca dudes de ti ni de todo lo que puedes lograr. Que tu linda mirada siga brillando como la recuerdo. ¡Que tengas un hermoso día! ❤️✨🌻";
            let i = 0;
            ...
            function escribir() {
                if (i < texto.length) {
                    ...
                    // Al terminar de escribir el texto, añade la imagen abajo
                    finalMsg.innerHTML = texto + '<br><img src="assets/Luci.jpg" class="final-image" alt="Foto">';
                }
            }
            escribir();
